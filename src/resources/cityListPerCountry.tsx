...
export const  SEACapitals: City[] = [
    ...
    { cityId: 1821306, cityName: 'Phnom Penh', country: 'Cambodia' },
    { cityId: 1651944, cityName: 'Vientiane', country: 'Laos' },
    { cityId: 1820814, cityName: 'Brunei Darussalam', country: 'Brunei' },
    { cityId: 1880252, cityName: 'Singapore', country: 'Singapore' },
];
